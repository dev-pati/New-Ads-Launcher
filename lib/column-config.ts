...
export interface ColumnDef {
  ...
  sectionLabel: string
  sortKey?: string     // internal sort key if sortable
}
...
export const COLUMN_DEFS: ColumnDef[] = [
  ...
  // ── Ad settings ────────────────────────────────────────────────────────────
  { id: "schedule_start",    label: "Schedule",                headerLabel: "Schedule",          description: "Start date for the campaign or ad set.",   tab: "ad_settings", section: "ad_settings_section", sectionLabel: "Ad settings" },
  { id: "schedule_end",      label: "Ends",                    headerLabel: "Ends",              description: "End date for the campaign or ad set.",     tab: "ad_settings", section: "ad_settings_section", sectionLabel: "Ad settings" },
  { id: "optimization_goal", label: "Optimization Goal",       headerLabel: "Optimization",      description: "The optimization goal for this ad set.",   tab: "ad_settings", section: "ad_settings_section", sectionLabel: "Ad settings" },
