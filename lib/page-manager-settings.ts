    ...
    templates: [
      {
        ...
        name: "Xin chao",
        shortcut: "/hello",
        body: "{Xin chao|Chao ban|Hi} {first_name}, cam on ban da nhan tin. Minh co the ho tro gi cho ban hom nay?",
      },
      {
        id: "pricing",
        name: "Pricing",
        shortcut: "/price",
        body: "Thanks for reaching out. I can send the pricing and bundle options here.",
      },
      {
        id: "shipping",
        name: "Shipping",
        shortcut: "/ship",
        body: "Shipping time depends on your location. Please send your city or ZIP code.",
      },
    ],
  },
  integrations: {
