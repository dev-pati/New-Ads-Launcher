...
export const ACTIVITY_CATALOG: ActivityDefinition[] = [
  ...
  {
    key: "creative.uploaded",
    label: "Creative uploaded",
    class: "produce",
    status: "live",
    match: ["creative:created"],
    surface: "Assets (/assets) — Upload creative and Bulk upload. Also Upload ads (/upload-ads).",
    evidence: "asset.uploaded from /api/creatives, /finalize and /upload-binary.",
    kpi: "Automation coverage",
  },
  {
    key: "creative.meta_ready",
    label: "Creative delivered to Meta",
    class: "produce",
    status: "live",
    match: ["upload_job:completed"],
    surface: "Assets (/assets) — Assign to Meta. Counted when the upload queue finishes the asset, not when you click.",
    evidence: "media.upload_completed when an upload job finishes — fb_image_hash or fb_video_id exists.",
    kpi: "Time-to-launch",
  },
  {
    ...
    surface: "Assets (/assets) — Portal Vault, assigning an approved asset to an org and ad account.",
    evidence: "media.assigned from /api/portal-media/assignments; also recorded on portal_media_assignments.assigned_by.",
    minutesSaved: 2,
