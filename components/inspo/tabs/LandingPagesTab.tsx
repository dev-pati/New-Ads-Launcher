        ...
        <table data-table="comfortable" className="w-full text-sm">
          <thead>
            <tr className="border-b border-border/50 text-muted-foreground text-xs uppercase tracking-wide">
              <th className="text-left px-3 font-semibold">Landing Page URL</th>
              ...
              <th className="w-20 px-3 text-right font-semibold text-xs uppercase tracking-wide">Actions</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-border/30">
            {sorted.map((row, i) => (
              <tr key={i} className="hover:bg-muted/20 transition-colors">
                ...
                <td className="px-3 text-right tabular-nums font-semibold">{row.adsCount}</td>
