...
import { reachSnapshotFallback, datePresetToRange } from "@/lib/snapshot-fallback"
  ...
  try {
    ...
    try {
      ...
      if (ctx2 && adAccountId) {
        ...
        const snapshot = await reachSnapshotFallback(ctx2.orgId, adAccountId, since, until)
